...
def info():
    ...
    string = font.render('Разработчик:', 2, pygame.Color('Red'))
    string_info = font_info.render('Артем Юсипов', 1, pygame.Color('Black'))
...
def main():
    ...
    string_info = font_info.render('О разработчике', 1, pygame.Color('Grey'))
    pygame.mouse.set_visible(True)
    rect = string_rendered.get_rect()
    rect_exit = string_exit.get_rect()
